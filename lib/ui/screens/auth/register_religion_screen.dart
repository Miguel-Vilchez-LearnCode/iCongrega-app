...
class RegisterReligionScreen extends StatelessWidget {
  const RegisterReligionScreen({super.key});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Para registrar una religion en nuestra plataforma, comunícate con nuestro equipo de atención al cliente. Te responderemos en menos de 24 horas.',
              style: TextStyle(
                fontSize: 14,
