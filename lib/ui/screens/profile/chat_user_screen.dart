...
class ChatUserScreen extends StatefulWidget {
  ...
  const ChatUserScreen({super.key, required this.title, required this.subtitle, required this.avatarUrl});
                          ...
                          SizedBox(
                            ...
                            child: Stack(
                              children: [
                                CircleAvatar(
                                  radius: 16,
                                  backgroundImage: Image.network('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTg7ddYVuvul35k6x8wtmWmX7jSFwK3JkBHWQ&s', fit: BoxFit.cover).image,
                                ),
                                Positioned(
                                  right: 0,
                                  child: CircleAvatar(
